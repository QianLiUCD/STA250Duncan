# Make freqence table by block, then calcalute the mean,sd, median
# Outcome: result2 and time2 (only for year=1990)
...
time2 = 
  system.time(result2 <- Block_freq (BlockSize = 1000))